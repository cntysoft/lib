...
Ext.require('Cntysoft.Kernel.StdPath', function()
{
   ...
   /**
    * 封装CKEDITOR富文本编辑器，使用七牛云上传
    */
   Ext.define('Cntysoft.Component.QiniuCkEditor.Editor', {
      extend : 'Ext.Component',
      alias : 'widget.cmpqiniuckditor',
      mixins : {
       ...
       */
      requires : [
         'Cntysoft.Component.QiniuCkEditor.CkExt.DialogCommand',
         'Cntysoft.Component.QiniuCkEditor.CkExt.PluginManager',
         'Cntysoft.Component.QiniuCkEditor.Config',
         //Lang
         'Cntysoft.Component.QiniuCkEditor.Lang.zh_CN',
         //CkExt
         'Cntysoft.Component.QiniuCkEditor.CkExt.AbstractPlugin',
         'Cntysoft.Component.QiniuCkEditor.CkExt.Dialog',
         'Cntysoft.Component.QiniuCkEditor.CkExt.DialogCommand',
         'Cntysoft.Component.QiniuCkEditor.CkExt.PluginManager',
         'Cntysoft.Component.QiniuCkEditor.CkExt.Plugins.Image.Main',
         'Cntysoft.Component.QiniuCkEditor.CkExt.Plugins.Image.Comp.ImageAlign',
         'Cntysoft.Component.QiniuCkEditor.CkExt.Plugins.Image.Dialogs.Image'
      ],
      /**
       * @inheritdoc
       */
      LANG_NAMESPACE : 'Cntysoft.Component.QiniuCkEditor.Lang',
      autoEl : {
         tag : 'textarea'
      },
      /**
