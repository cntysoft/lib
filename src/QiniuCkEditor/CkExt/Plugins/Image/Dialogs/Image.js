 ...
 * 图片管理器
 */
Ext.define('Cntysoft.Component.QiniuCkEditor.CkExt.Plugins.Image.Dialogs.Image', {
   extend : 'Cntysoft.Component.QiniuCkEditor.CkExt.Dialog',
   requires : [
         ...
         items : [{
            ...
            items : [{
               ...
               items : [{
                  ...
                  height : 80,
                  name : 'description'
               }, new Cntysoft.Component.QiniuCkEditor.CkExt.Plugins.Image.Comp.ImageAlign({
                  height : 40,
                  labelWidth : 80,
