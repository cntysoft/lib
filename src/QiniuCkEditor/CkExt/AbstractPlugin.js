 ...
 * 抽象的插件对象
 */
Ext.define('Cntysoft.Component.QiniuCkEditor.CkExt.AbstractPlugin', {
   requires : [
   ...
   basePath : null,
   /**
    * @property {Cntysoft.Component.QiniuCkEditor.CkExt.DialogCommand} command
    */
   command : null,
   /**
    * 是否具有CSS样式
    ...
    * 系统封装之后的CK编辑器
    *
    * @property {Cntysoft.Component.QiniuCkEditor.Editor} EDITOR
    */
   EDITOR : null,
   /**
    * 弹窗对象引用
   ...
   constructor : function(config)
   {
      ...
      //TODO 修改路径
      this.basePath = Cntysoft.Kernel.StdPath.getPlatformResPath() + '/Images/Comp/QiniuCkEditor/Plugins/' + this.name;
   ...
   getCommandObject : function(config)
   {
      ...
      if(null == this.command){
         this.path = new Cntysoft.Component.QiniuCkEditor.CkExt.DialogCommand(config);
      }
      return this.path;
   },
   ...
   getDialog : function()
   {
      if(null == this.dialog){
         ...
         var cls = 'Cntysoft.Component.QiniuCkEditor.CkExt.Plugins.'+this.name+'.Dialogs.'+this.name;
