...
Ext.define('Cntysoft.Component.FsView.AbstractView', {
     ...
     * 路径显示label
     * 
     * @property {Ext.form.Label} pathLabel 
     */
    pathLabel : null,
    /**
     * 文件系统仓库
     ...
     * 文件浏览结构树
     * 
     * @property {Ext.tree.Panel} fsTree
     */
    fsTree : null,
    /**
     * 是否允许多选
    ...
    updateLabelText : function(path)
    {
        ...
        this.pathLabel.update(text + ':  ' + path);
    },
    /**
     * 刷新当前的view，子类覆盖的方法
     */
    ...
    renderUploaderWindow : function()
    {
        ...
        Ext.require('Cntysoft.Component.Uploader.Window', function(){
            ...
            if(null == this.uploader){
                ...
                this.uploader = new Cntysoft.Component.Uploader.Window(this.uploaderConfig);
            } else{
                this.uploader.changUploadPath('/' + this.path);
            }
            this.uploader.center();
            this.uploader.show();
        }, this);
    },
    /**
    ...
    destroy : function()
    {
        ...
        if(this.batchMenu){
            this.batchMenu.destroy();
            delete this.batchMenu;
        }
        if(this.itemFileMenu){
            this.itemFileMenu.destroy();
            delete this.itemFileMenu;
        }
        if(this.itemDirMenu){
            this.itemDirMenu.destroy();
            delete this.itemDirMenu;
        }
